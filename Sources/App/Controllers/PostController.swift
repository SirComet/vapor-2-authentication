...
final class PostController {
    ...
    func addRoutes() {
        ...
        tokenAuthed.get("posts", handler: getAllPosts)
        tokenAuthed.get("posts", Int.parameter, handler: getPost)
        tokenAuthed.put("posts", Int.parameter, handler: updatePost)
        tokenAuthed.delete("posts", Int.parameter, handler: deletePost)
        
        tokenAuthed.group("posts") { posts in
